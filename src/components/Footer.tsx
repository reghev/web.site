    ...
    <footer className="bg-black border-t border-gray-200 py-12">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="border-t border-gray-200 pt-8 text-center">
          <a href="/Shhh" className="inline-block">
            <ShinyText
              text="© -29 BC Raghav. All rights reserved."
              className="text-gray-500 font-bold cursor-pointer hover:opacity-80 transition-opacity"
            />
          </a>
        </div>
      </div>
