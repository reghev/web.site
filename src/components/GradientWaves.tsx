...
const GradientWaves = ({
  ...
  }, [waveSpeedX, waveSpeedY, waveAmpX, waveAmpY, friction, tension, maxCursorMove, xGap, yGap]);
    ...
    function drawLines() {
      ...
      linesRef.current.forEach(points => {
        points.forEach((p: any, idx: number) => {
          ...
          const p1 = moved(p, true);
          const p2 = moved(points[idx + 1], true);
          
          const gradientPos = p1.y / height;
          
          const r = Math.round(0 + gradientPos * 16);
          const g = Math.round(0 + gradientPos * 185);
          const b = Math.round(0 + gradientPos * 129);
          const alpha = 0.15;
